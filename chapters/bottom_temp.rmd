...
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp(shadedRegion=c(2013,2022))
print(ggplotObject)
```
```{r plot_bottom_tempNE}
# Plot indicator
ggplotObject <- ecodata::plot_bottom_temp(shadedRegion=c(2013,2022),report='NewEngland')
print(ggplotObject)
```
...
**Point of contact**: [Paula.Fratantoni@noaa.gov](Paula.Fratantoni@noaa.gov){.email}

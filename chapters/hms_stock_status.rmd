...
# Plot indicator
ggplotObject <- ecodata::plot_hms_stock_status(shadedRegion=c(2013,2022))
print(ggplotObject)
```
```{r plot_hms_stock_statusNE}
# Plot indicator
ggplotObject <- ecodata::plot_hms_stock_status(shadedRegion=c(2013,2022),report='NewEngland')
print(ggplotObject)
```

...
```{r plot_zoo_abundance_anomMidAtlanticeuphasid}
# Plot indicator
ggplotObject <- ecodata::plot_zoo_abundance_anom(report= 'MidAtlantic', varName= 'euphasid')
ggplotObject
```
...
```{r plot_zoo_abundance_anomNewEnglandeuphasid}
# Plot indicator
ggplotObject <- ecodata::plot_zoo_abundance_anom(report= 'NewEngland', varName= 'euphasid')
ggplotObject
```

...
Evaluating fish condition can provide insight into the health of fish populations, where higher relative condition indicates fatter, healthier fish. These changes in condition can directly cause implications for stock assessments, catch quotas and management and may indirectly impact fish recruitment and mortality. Annual changes in condition can be due to many factors including changes in prey abundance, density dependence, system productivity, temperature or even fishing pressure. 

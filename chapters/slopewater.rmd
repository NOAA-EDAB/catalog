...
```{r plot_slopewaterMAB}
# Plot indicator
ggplotObject <- ecodata::plot_slopewater(shadedRegion=c(2013,2022))
print(ggplotObject)
```
```{r plot_slopewaterNE}
# Plot indicator
ggplotObject <- ecodata::plot_slopewater(shadedRegion=c(2013,2022),report='NewEngland')
print(ggplotObject)
```

...
```{r plot_productivity_anomalyMidAtlanticanomalyGB}
# Plot indicator
ggplotObject <- ecodata::plot_productivity_anomaly(report= 'MidAtlantic', varName= 'anomaly' ,EPU= 'GB')
print(ggplotObject)
```

```{r plot_productivity_anomalyMidAtlanticanomalyGOM}
# Plot indicator
ggplotObject <- ecodata::plot_productivity_anomaly(report= 'MidAtlantic', varName= 'anomaly' ,EPU= 'GOM')
print(ggplotObject)
```
...
```{r plot_productivity_anomalyMidAtlanticassessmentGB}
# Plot indicator
ggplotObject <- ecodata::plot_productivity_anomaly(report= 'MidAtlantic', varName= 'assessment' ,EPU= 'GB')
print(ggplotObject)
```

```{r plot_productivity_anomalyMidAtlanticassessmentGOM}
# Plot indicator
ggplotObject <- ecodata::plot_productivity_anomaly(report= 'MidAtlantic', varName= 'assessment' ,EPU= 'GOM')
print(ggplotObject)
```

### NewEngland

```{r plot_productivity_anomalyNewEnglandanomalyMAB}
# Plot indicator
ggplotObject <- ecodata::plot_productivity_anomaly(report= 'NewEngland', varName= 'anomaly' ,EPU= 'MAB')
print(ggplotObject)
```
...
```{r plot_productivity_anomalyNewEnglandassessmentMAB}
# Plot indicator
ggplotObject <- ecodata::plot_productivity_anomaly(report= 'NewEngland', varName= 'assessment' ,EPU= 'MAB')
print(ggplotObject)
```

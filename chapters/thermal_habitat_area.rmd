...
**ecodata name**: `ecodata::thermal_habitat_area` `ecodata::thermal_habitat_area_annual`

**Variable definitions**

Time: year EPU: EPU name Depth: Depth category Var: Temperature Category Value: Proportion of area above temp.threshold Source: GLORYS (CMEM’s GLORYS12V1 global reanalysis bottom temperature) temp.threshold: numeric temperature category Units: Proportion

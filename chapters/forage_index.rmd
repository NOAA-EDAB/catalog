...
```{r plot_forage_indexMAB}
# Plot indicator
ggplotObject <- ecodata::plot_forage_index(shadedRegion=c(2013,2022))
print(ggplotObject)
```
```{r plot_forage_indexNE}
# Plot indicator
ggplotObject <- ecodata::plot_forage_index(shadedRegion=c(2013,2022),report='NewEngland')
print(ggplotObject)
```

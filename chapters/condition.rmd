...
```{r plot_conditionMAB}
# Plot indicator
ggplotObject <- ecodata::plot_condition(shadedRegion=c(2013,2022))
print(ggplotObject)
```
```{r plot_conditionNE}
# Plot indicator
ggplotObject <- ecodata::plot_condition(shadedRegion=c(2013,2022),report='NewEngland')
print(ggplotObject)
```
...
**Point of contact**: [Laurel.smith@noaa.gov](Laurel.smith@noaa.gov){.email}

...
Variable plotted are the mean energy density (kJ/g) for eight species across seasons and years. The reference lines represent estimates from prior studies where available for comparison. The energy density of Atlantic Herring has been well below the available estimates from the 1980s and 1990s, but is showing some signs of improving. 2017-2022 are building toward a time series to evaluate trends (Fig. ). Data from the fall 2021 and spring 2022 survey measurements were consistent with previous reports:

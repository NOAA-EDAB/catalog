...
# Plot indicator
ggplotObject <- ecodata::plot_energy_density(shadedRegion=c(2013,2022))
print(ggplotObject)
```
```{r plot_energy_densityNE}
# Plot indicator
ggplotObject <- ecodata::plot_energy_density(shadedRegion=c(2013,2022),report='NewEngland')
print(ggplotObject)
```
...
**Point of contact**: [Mark Wuenschel (mark.wuenschel@noaa.gov)](Mark Wuenschel (mark.wuenschel@noaa.gov)){.email}

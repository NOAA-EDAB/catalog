...
# Plot indicator
ggplotObject <- ecodata::plot_ches_bay_wq(shadedRegion=c(2013,2022))
print(ggplotObject)
```
```{r plot_ches_bay_wqNE}
# Plot indicator
ggplotObject <- ecodata::plot_ches_bay_wq(shadedRegion=c(2013,2022),report='NewEngland')
print(ggplotObject)
```
...
**Point of contact**: [Qian Zhang, qzhang@chesapeakebay.net](Qian Zhang, qzhang@chesapeakebay.net){.email}

...
Revenue in an EPU in a given year is the product of quantities landed times prices received from all species groups (or guilds) within the EPU. At time t, revenue (R) in an EPU is defined as:

Rt=j=1Jpjtyjt
where pj is the price for species group j, and yj is the quantity landed of species group j. Revenue change between any two time periods, say t+1 and t, is then Rt+1-Rt which can also be expressed as: 

R=j=1Jpjt+1yjt+1-j=1Jpjtyjt.

This change can be decomposed further, yielding a VI and PI. The VI is calculated using the following formula (Georgianna, Lee, and Walden 2017):

VI=12(j=1Jpjt+1yjt+1-j=1Jpjt+1yjt+j=1Jpjtyjt+1-j=1Jpjtyjt)

The price indicator (PI) is calculated as follows:

PI=12(j=1Jyjt+1pjt+1-j=1Jyjt+1pjt+j=1Jyjtpjt+1-j=1Jyjtpjt)

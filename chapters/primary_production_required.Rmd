...
The amount of total fish yield we can expect from a marine ecosystem depends on the amount of production entering
...
80-90%. For many fish species, as many as 2-4 steps may be necessary. Given the trophic level and the efficiency
...
knitr::include_graphics(paste0(image.dir,"/PPR-MAB-0_80.png"))
knitr::include_graphics(paste0(image.dir,"/MTL-MAB-0_80.png"))
knitr::include_graphics(paste0(image.dir,"/PP-MAB.png"))
knitr::include_graphics(paste0(image.dir,"/composition-MAB-0_80.png"))
```


```{r ppr-mab, fig.cap="Primary production required to support the commercial landings in the Mid-Atlantic Bight. Included are the top species accounting for 80% of the landings in each year."}
ppr<-ecodata::ppr %>% 
  dplyr::group_by(EPU) %>% 
...
```{r}
library(DT)
datatable(ecodata::ppr, options = list(pageLength = 10))
```
